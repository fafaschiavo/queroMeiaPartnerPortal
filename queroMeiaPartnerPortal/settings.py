"""
Django settings for queroMeiaPartnerPortal project.
...
SECRET_KEY = ')g=#g3_$i4eu2_219ek#m(a%bsh-704%&$opobu+xzuyacnp7i'
...
ROOT_URLCONF = 'queroMeiaPartnerPortal.urls'
...
WSGI_APPLICATION = 'queroMeiaPartnerPortal.wsgi.application'
